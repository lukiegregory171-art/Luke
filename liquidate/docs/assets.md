...
**Verticality (real, server-authoritative):** "Trading Floor" and "Datacenter"
now have a true upper level — raised CATWALK obstacles (`box(..., y=2.2)`) that
FLOAT at 2.2–2.6.
...
**Still to add:** the upper-level treatment on the remaining 3 maps, richer
