...
| **Weapons** — `rifle` (blaster-repeater) / `pistol` (blaster) (`client/assets/raw/weapons/*` → `client/public/assets/weapons/*`) | Real first-person/inspect models for the assault + pistol archetypes (recoloured by the equipped skin); the other 5 weapons stay procedural | [KenneyNL/Starter-Kit-FPS](https://github.com/KenneyNL/Starter-Kit-FPS) | [Kenney](https://kenney.nl) | **MIT** |
